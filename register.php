...
if(isset($_POST['register']))
{
    ...
    $sql = "INSERT INTO registration (user_name, phone, address, password, created_date) VALUES ('$name', '$phoneno', '$address', '$password' ,now())";
        ...
        <div class="col-lg-6">
            <form action="" method="POST">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="phone" id="phone" placeholder="phone" style="max-width: 300px; margin: auto;">
                            <label for="phone">User PhoneNo</label>
                        </div>
                    </div>

                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="address" id="address" placeholder="address" style="max-width: 300px; margin: auto;">
